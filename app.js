...
(function () {
  ...
  /* ============================================================
     VIDEO — first thing in the script, before any GSAP code.
     Chrome re-evaluates a video's autoplay eligibility the moment
     its parent compositing layer changes. By attempting play() here
     — before GSAP has touched anything — the play request is already
     queued and granted before the parallax layer is even created.
     ============================================================ */
  (function earlyVideoPlay() {
  ...
  function tryPlay() {
    ...
    /* Re-assert muted every attempt — some browsers silently reset it */
    videoEl.muted = true;
    videoEl.defaultMuted = true;
    videoEl.setAttribute("muted", "");
    const p = videoEl.play();
    if (p && typeof p.catch === "function") p.catch(() => { /* autoplay blocked — will retry */ });
  }
  ...
  function initVideo() {
    ...
    /* Trigger 1: force network fetch immediately, regardless of layout */
